...
class DBController
{
    ...
    {
        $sql = "INSERT INTO Alexa_coop VALUES(:user_id, :pass_id_left)
            ON DUPLICATE KEY UPDATE pass_id = :pass_id_right";
        $stm = $this->pdo->prepare($sql);
        $stm->bindValue(":user_id", $user_id, PDO::PARAM_INT);
        $stm->bindValue(":pass_id_left", $pass_id, PDO::PARAM_INT);
        $stm->bindValue(":pass_id_right", $pass_id, PDO::PARAM_INT);
