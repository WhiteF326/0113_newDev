...
<div class="row">
    ...
    <div class="breadcrumb">
		<ul>
        <li><a href="index.php">ホーム</a> > <a href="confrim.php?id=<?php echo $_SESSION['now_user'];?>">登録物一覧</a> > <a href="time_top.php">時間登録</a> > <a href="family_top.php">グループトップ</a> > Alexaと連携</li>
		</ul>
		</div>
    <div class="news">
		<h2>Alexaと連携</h2>
