...
<div class="row">
	...
	<div class="breadcrumb">
		<ul>
			<li><a href="index.php">ホーム</a> > <a href="confilm.php?id=<?php echo $_SESSION['user_id'];?>">登録物一覧</a> > 時間登録</li>
		</ul>
		</div>
    ...
    <a href="confilm.php?id=<?php echo $_SESSION['user_id'];?>"><img src="img/2.png" alt="バナー画像"></a>
	</div>
    </div>    
        </div>
	</article>
