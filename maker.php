...
<div class="row">
    ...
    <div class="breadcrumb">
		<ul>
        <li><a href="index.php">ホーム</a> > <a href="confrim.php?id=<?php echo $_SESSION['user_id'];?>">登録物一覧</a> > <a href="time_top.php">時間登録</a> > <a href="family_top.php">グループトップ</a> > <a href="alexa_cooperation.php">Alexaと連携</a> > 製作者情報</li>
		</ul>
		</div>
    <div class="news">
